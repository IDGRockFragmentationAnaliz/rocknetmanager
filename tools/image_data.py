...
class ImageData:
    ...
    def load(cls, image_folder):
        ...
        path_image = (image_folder / image_folder.name)
        path_image = _get_existed_image_path_extension(path_image)
        if path_image is None:
            print("Error: image does not exits")
        #
...
def _get_existed_image_path_extension(image_path: Path):
    extensions = [".png", ".jpg", ".jpeg", ".tif", ".tiff"]
    for ext in extensions:
        possible_path = image_path.with_suffix(ext)
